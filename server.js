...
/******/ 			var chunk = require("./" + ({"1":"pages/imprint","2":"pages/index"}[chunkId]||chunkId) + ".js");
...
module.exports = __webpack_require__.p + "fonts/Inter-Light-BETA.377afab.ttf";

/***/ }),
/* 12 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fonts/Inter-Medium.4030a28.ttf";
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(3).default("27894c40", content, true)
...
// Module
exports.push([module.i, "@font-face{font-family:\"inter-regular\";font-weight:400;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") format(\"opentype\")}@font-face{font-family:\"inter-bold\";font-weight:400;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ") format(\"opentype\")}h1,h2,h3,h4,h5{font-family:\"inter-bold\",\"Helvetica Neue\",sans-serif}h1{font-size:62px}h2{font-size:42px;text-transform:uppercase;margin:68px 0}h3{font-size:24px;margin-bottom:41px}h4{font-size:18px}@media screen and (max-width:767.99px){h1,h2,h3,h4,h5{margin-left:20px;margin-right:20px}}@media screen and (max-width:575.99px){h2{font-size:42px;text-transform:uppercase;margin:41px 20px}h3{font-size:24px;margin-bottom:41px 20px}}a:active,a:link{color:#fff;font-style:none}a:hover,a:visited{color:#fff}.container{margin:0;padding:0;min-width:100%;min-height:100vh;display:flex;justify-content:center;align-items:center;text-align:left}.wrapper{max-width:950px;margin:0 auto}.index-wrapper{width:100%}.index-wrapper>:first-of-type{padding:68px 0 140px}.index-wrapper>:nth-of-type(n+2){padding:140px 0}.table,.text-box{margin:68px 0 0}.logo{margin-bottom:68px}img{width:100%;height:100%;-o-object-fit:cover;object-fit:cover}@media screen and (max-width:767.99px){.container.index{padding:0}.container .index-wrapper>:first-of-type{padding:0 0 41px}.container .index-wrapper>:nth-of-type(n+2){padding:41px 0}.container .table--wrapper,.container .text-box--content{margin:0 20px}}.gallery{margin-bottom:60px;padding:68px 0}.gallery .carousel-indicators{bottom:-60px}.gallery .carousel-indicators li{width:20px;border:1px solid transparent;border-radius:10px;height:20px;margin-right:13px;margin-left:13px;background-color:#fff;border-top:initial;border-bottom:initial}.gallery .carousel-inner{max-height:560px}@media screen and (max-width:575.99px){.gallery .carousel-indicators li{width:16px;border-radius:8px;height:16px;margin-right:0;margin-left:10px}}.text-box .text-box--content{text-align:justify;text-justify:auto}.text-box p{margin:41px 0}.table{color:#fff}.table th{text-transform:uppercase}.table td,.table th{border-top:none;padding:rem(17px) .75rem}.table thead th{border-bottom:none}.table-striped tbody tr:nth-of-type(odd){background-color:hsla(0,0%,100%,.1)}.submenu-header--img{position:relative;height:400px;width:100%;overflow:hidden}.logo h1{width:450px}.imprint .text-box .wrapper{max-width:none;width:950px}@media screen and (max-width:767.99px){.imprint .text-box .wrapper{max-width:none;width:calc(100vw - 30px)}}@media screen and (max-width:575.99px){.imprint .text-box .wrapper{width:calc(100vw - 15px)}}", ""]);
// Exports
module.exports = exports;
...
// Module
exports.push([module.i, "@font-face{font-family:\"inter-regular\";font-weight:400;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") format(\"opentype\")}@font-face{font-family:\"inter-bold\";font-weight:400;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ") format(\"opentype\")}h1,h2,h3,h4,h5{font-family:\"inter-bold\",\"Helvetica Neue\",sans-serif}h1{font-size:62px}h2{font-size:42px;text-transform:uppercase;margin:68px 0}h3{font-size:24px;margin-bottom:41px}h4{font-size:18px}@media screen and (max-width:767.99px){h1,h2,h3,h4,h5{margin-left:20px;margin-right:20px}}@media screen and (max-width:575.99px){h2{font-size:42px;text-transform:uppercase;margin:41px 20px}h3{font-size:24px;margin-bottom:41px 20px}}a:active,a:link{color:#fff;font-style:none}a:hover,a:visited{color:#fff}.container{margin:0;padding:0;min-width:100%;min-height:100vh;display:flex;justify-content:center;align-items:center;text-align:left}.wrapper{max-width:950px;margin:0 auto}.index-wrapper{width:100%}.index-wrapper>:first-of-type{padding:68px 0 140px}.index-wrapper>:nth-of-type(n+2){padding:140px 0}.table,.text-box{margin:68px 0 0}.logo{margin-bottom:68px}img{width:100%;height:100%;-o-object-fit:cover;object-fit:cover}@media screen and (max-width:767.99px){.container.index{padding:0}.container .index-wrapper>:first-of-type{padding:0 0 41px}.container .index-wrapper>:nth-of-type(n+2){padding:41px 0}.container .table--wrapper,.container .text-box--content{margin:0 20px}}.gallery{margin-bottom:60px;padding:68px 0}.gallery .carousel-indicators{bottom:-60px}.gallery .carousel-indicators li{width:20px;border:1px solid transparent;border-radius:10px;height:20px;margin-right:13px;margin-left:13px;background-color:#fff;border-top:initial;border-bottom:initial}.gallery .carousel-inner{max-height:560px}@media screen and (max-width:575.99px){.gallery .carousel-indicators li{width:16px;border-radius:8px;height:16px;margin-right:0;margin-left:10px}}.text-box .text-box--content{text-align:justify;text-justify:auto}.text-box p{margin:41px 0}.table{color:#fff}.table th{text-transform:uppercase}.table td,.table th{border-top:none;padding:rem(17px) .75rem}.table thead th{border-bottom:none}.table-striped tbody tr:nth-of-type(odd){background-color:hsla(0,0%,100%,.1)}.submenu-header--img{position:relative;height:400px;width:100%;overflow:hidden}.logo h1{width:450px}.imprint .text-box .wrapper{max-width:none;width:950px}@media screen and (max-width:767.99px){.imprint .text-box .wrapper{max-width:none;width:calc(100vw - 30px)}}@media screen and (max-width:575.99px){.imprint .text-box .wrapper{width:calc(100vw - 15px)}}*,:after,:before{margin:0;padding:0}.navbar-position{display:flex;flex-direction:column-reverse;position:relative;font-family:\"inter-regular\",\"Helvetica Neue\",Arial,sans-serif;color:#fff;font-size:16px;word-spacing:1px;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;box-sizing:border-box;background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ");background-attachment:fixed;background-position:50%;background-repeat:no-repeat;background-size:cover}.navbar-position #nav-icon{z-index:100;display:block;position:fixed;top:10px;right:25px;width:45px;height:45px;margin:50px 30px;transform:rotate(0deg);transition:.5s ease-in-out;cursor:pointer}.navbar-position #nav-icon span{display:block;position:absolute;height:2px;width:100%;background:#fff;border-radius:2px;opacity:1;left:0;transform:rotate(0deg);transition:.25s ease-in-out}.navbar-position #nav-icon span:first-child{top:0}.navbar-position #nav-icon span:nth-child(2),.navbar-position #nav-icon span :nth-child(3){top:10px}.navbar-position #nav-icon span:nth-child(4){top:20px}.navbar-position #nav-icon.open span:first-child{top:10px;width:0;left:50%}.navbar-position #nav-icon.open span:nth-child(2){top:10px;left:1px;transform:rotate(45deg)}.navbar-position #nav-icon.open span:nth-child(3){top:10px;left:1px;transform:rotate(-45deg)}.navbar-position #nav-icon.open span:nth-child(4){top:20px;width:0;left:50%}.navbar-position .nav-bar{display:none;width:100%;font-family:\"inter-bold\",\"Helvetica Neue\",sans-serif;margin:87px 50px 0;line-height:25px;font-size:18px;text-transform:uppercase;text-align:right}.navbar-position .nav-bar.open{z-index:99;display:block;position:-webkit-sticky;position:sticky;top:0;width:100%;height:100vh;margin:0;background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ");background-position:50%;background-repeat:no-repeat;background-size:cover;opacity:.9}.navbar-position .nav-bar .nav-bar--menu{margin:150px 54px 0}.navbar-position .nav-bar p{margin-top:0;margin-bottom:2.2rem}.navbar-position .nav-bar p:nth-last-of-type(2){margin-bottom:.3rem}.navbar-position .mobileMenu-enter-active,.navbar-position .mobileMenu-leave-active{transition:opacity 1.3s ease-out}.navbar-position .mobileMenu-enter,.navbar-position .mobileMenu-leave-to{opacity:.6}", ""]);
// Exports
module.exports = exports;
...
module.exports = __webpack_require__.p + "img/background-img.e41e849.png";
...
const _0f44440c = () => interopDefault(__webpack_require__.e(/* import() | pages/imprint */ 1).then(__webpack_require__.bind(null, 49)));

const _351c6083 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 2).then(__webpack_require__.bind(null, 50))); // TODO: remove in Nuxt 3
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=6634fd13&
var defaultvue_type_template_id_6634fd13_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"navbar-position"},[_c('nuxt'),_vm._ssrNode(" <div id=\"nav-icon\""+(_vm._ssrClass(null,{ open: _vm.showMenu }))+"><span></span> <span></span> <span></span> <span></span></div> "),_vm._ssrNode("<div"+(_vm._ssrClass("nav-bar",{ open: _vm.showMenu }))+">","</div>",[_c('transition',{attrs:{"name":"mobileMenu"}},[_c('div',{staticClass:"nav-bar--menu"},[_c('p'),_vm._v(" "),_c('nuxt-link',{directives:[{name:"scroll-to",rawName:"v-scroll-to",value:({ el: '#home-page' }),expression:"{ el: '#home-page' }"}],attrs:{"to":"/"}},[_vm._v("home")]),_vm._v(" "),_c('p'),_vm._v(" "),_c('nuxt-link',{directives:[{name:"scroll-to",rawName:"v-scroll-to",value:({ el: '#about' }),expression:"{ el: '#about' }"}],attrs:{"to":"/"}},[_vm._v("hof")]),_vm._v(" "),_c('p'),_vm._v(" "),_c('nuxt-link',{directives:[{name:"scroll-to",rawName:"v-scroll-to",value:({ el: '#offering' }),expression:"{ el: '#offering' }"}],attrs:{"to":"/"}},[_vm._v("angebot")]),_vm._v(" "),_c('p'),_vm._v(" "),_c('nuxt-link',{directives:[{name:"scroll-to",rawName:"v-scroll-to",value:({ el: '#assistance' }),expression:"{ el: '#assistance' }"}],attrs:{"to":"/"}},[_vm._v("mitarbeit")]),_vm._v(" "),_c('p'),_vm._v(" "),_c('nuxt-link',{directives:[{name:"scroll-to",rawName:"v-scroll-to",value:({ el: '#market' }),expression:"{ el: '#market' }"}],attrs:{"to":"/"}},[_vm._v("vermakrtung")]),_vm._v(" "),_c('p'),_c('p'),_vm._v(" "),_c('nuxt-link',{directives:[{name:"scroll-to",rawName:"v-scroll-to",value:({ el: '#contact' }),expression:"{ el: '#contact' }"}],attrs:{"to":"/"}},[_vm._v("kontakt")]),_vm._v(" "),_c('p'),_vm._v(" "),_c('nuxt-link',{attrs:{"to":"/imprint"}},[_vm._v("impressum /"),_c('p',[_vm._v("datenschutz")])])],1)])],1)],2)}
var defaultvue_type_template_id_6634fd13_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=6634fd13&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  ...
  defaultvue_type_template_id_6634fd13_render,
  defaultvue_type_template_id_6634fd13_staticRenderFns,
  false,
  ...
  const app = {
    head: {
      ...
      "meta": [{
        ...
        "hid": "description",
        "name": "description",
        "content": "website for the berlin-farmer gaertnerinnenhof web design :"
      }],
      "link": [{
        "rel": "icon",
        "type": "image\u002Fx-icon",
